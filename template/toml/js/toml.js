// Source: http://tomljs.s3-website-us-east-1.amazonaws.com/toml.js
// http://tomljs.s3-website-us-east-1.amazonaws.com/
...
TOML.parse = function(text) {
  ...
  for (lineNum = _i = 0, _len = _ref.length; _i < _len; lineNum = ++_i) {
    ...
    if (line.match(/^\[[_a-zA-Z](\w|\.)*]$/)) {
      ...
      console.log("Invalid statement on line " + lineNum)
    } else {
      ...
      if (value.match(isArray = /^\[.*]$/)) {
        ...
        if (val === null) {
          ...
          console.log("Invalid value with assignment on line " + lineNum)
        }
      }
      keygroup[key] = val;
    }
